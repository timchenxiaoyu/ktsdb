...
import (
	...
	"ktsdb/client_golang/ktsdb"
	"ktsdb/common/log"
	"github.com/samuel/go-zookeeper/zk"
)

var (
	failureCounter = ktsdb.NewCounter(ktsdb.CounterOpts{
		Namespace: "ktsdb",
		Subsystem: "treecache",
		Name:      "zookeeper_failures_total",
		Help:      "The total number of ZooKeeper failures.",
	})
	numWatchers = ktsdb.NewGauge(ktsdb.GaugeOpts{
		Namespace: "ktsdb",
		Subsystem: "treecache",
...
func init() {
	ktsdb.MustRegister(failureCounter)
	ktsdb.MustRegister(numWatchers)
}
