...
func newPersistence(
	...
	p := &persistence{
		...
		//indexingQueueLength: ktsdb.NewGauge(ktsdb.GaugeOpts{
		//	Namespace: namespace,
		//	Subsystem: subsystem,
		//	Name:      "indexing_queue_length",
		//	Help:      "The number of metrics waiting to be indexed.",
		//}),
		//indexingQueueCapacity: ktsdb.MustNewConstMetric(
		//	ktsdb.NewDesc(
		//		ktsdb.BuildFQName(namespace, subsystem, "indexing_queue_capacity"),
		...
		//),
		//indexingBatchSizes: ktsdb.NewSummary(
		//	ktsdb.SummaryOpts{
		//		Namespace: namespace,
		//		Subsystem: subsystem,
		...
		//	},
		//),
		//indexingBatchDuration: ktsdb.NewSummary(
		//	ktsdb.SummaryOpts{
		//		Namespace: namespace,
		//		Subsystem: subsystem,
		...
		//	},
		//),
		//checkpointLastDuration: ktsdb.NewGauge(ktsdb.GaugeOpts{
		//	Namespace: namespace,
		//	Subsystem: subsystem,
		...
		//}),
		//checkpointDuration: ktsdb.NewSummary(ktsdb.SummaryOpts{
		//	Namespace:  namespace,
		//	Subsystem:  subsystem,
		...
		//}),
		//dirtyCounter: ktsdb.NewCounter(ktsdb.CounterOpts{
		//	Namespace: namespace,
		//	Subsystem: subsystem,
...
// Describe implements ktsdb.Collector.
//func (p *persistence) Describe(ch chan<- *ktsdb.Desc) {
...
//}
//
//// Collect implements ktsdb.Collector.
//func (p *persistence) Collect(ch chan<- ktsdb.Metric) {
