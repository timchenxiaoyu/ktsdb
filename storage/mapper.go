...
func newFPMapper(fpToSeries *seriesMap, p *persistence) (*fpMapper, error) {
	m := &fpMapper{
		...
		p:          p,
		//mappingsCounter: ktsdb.NewCounter(ktsdb.CounterOpts{
		//	Namespace: namespace,
		//	Subsystem: subsystem,
...
//func (m *fpMapper) Describe(ch chan<- *ktsdb.Desc) {
//	ch <- m.mappingsCounter.Desc()
//}
//
//// Collect implements ktsdb.Collector.
//func (m *fpMapper) Collect(ch chan<- ktsdb.Metric) {
